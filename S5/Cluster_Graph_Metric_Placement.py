...
if __name__ == "__main__":
    ...
    pd.DataFrame(data=output).to_csv('gateways_Placement_Cluster.csv')
    pd.DataFrame(data=outputsens).to_csv('reachable_sensors_Cluster.csv')
    pd.DataFrame(data=outputsens).to_json('reachable_sensors_Cluster.json')
