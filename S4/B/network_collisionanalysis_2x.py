...
for i in range(len(sensor_data_paths_hata)):
    ...
    sensor_data['NumberOfSensors'] = sensor_data['NumberOfSensors'] * messages_per_hour
    sensor_data['range'] = sensor_data['range'] * messages_per_hour
    for k in range(len(sensor_data)):
        sensor_data.sf_collisions[k] = [element * messages_per_hour for element in sensor_data.sf_collisions[k]]
...
collision_dataframe.to_csv('2000mitFixedGateways_2x.csv')
collision_dataframe.to_json('2000mitFixedGateways_2x.json')
